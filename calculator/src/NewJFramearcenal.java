 ...
 * @author AICS-CEBU
 */
public class NewJFramearcenal extends javax.swing.JFrame {

    /**
     * Creates new form NewJFramearcenal
     */
    private Double val1,val2,answer;
    public NewJFramearcenal() {
        initComponents();
    }
    ...
    answer=val1+val2;
    jLabel4.setText(answer.toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NewJFramearcenal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NewJFramearcenal().setVisible(true);
            }
        });
    }
